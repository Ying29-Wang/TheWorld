...
public class SpaceTest {
  ...
  public void testSpace() {
    ...
    assertEquals(s.toString(),"Space No.0 kitchen ; upleft:2,5; downright：10,8;\nincludes 0 items\nit has 0 neighbors\n");
  }
  ...
  public void testSpaceUpleftEqual() {
    Space s=new Space(0,"kitchen",new int[] {15,5},new int[] {15,8});
    //assertEquals(s.toString(),"Space No.0 kitchen ; upleft:2,5; downright：10,8;\nincludes 0 items\nit has 0 neighbors\n");
  }
  /**
   * illegal arg upleft > downright
  ...
  public void testSpaceUpleftBigger() {
    Space s=new Space(0,"kitchen",new int[] {10,11},new int[] {15,8});
    //assertEquals(s.toString(),"Space No.0 kitchen ; upleft:2,5; downright：10,8;\nincludes 0 items\nit has 0 neighbors\n");
  }
  ...
  /**
   * test calculate Neighbors from the space ,multi conditions,include 0 neighbor 1 neighbor 2 neighbors
   */
  @Test
  public void testCalculateNeighbors() {
    ...
    //System.out.println(((Space)this.spaces.get(0)).getNeighbors().size());
    assertEquals(((Space)this.spaces.get(0)).getNeighbors().size(),2);
    assertEquals(((Space)this.spaces.get(1)).getNeighbors().size(),2);
    //System.out.print(((Space)this.spaces.get(2)).toString());
  ...
  public void testToString() {
    ...
    assertEquals(((Space)this.spaces.get(0)).toString(),"Space No.0 kitchen ; upleft:10,10; downright：20,20;\n"
        + "includes 1 items\n"
        + "includes mop ,cause 5 hurt\n"
        + "it has 2 neighbors\n"
